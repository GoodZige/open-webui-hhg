...
export const getUserByToken = async (clientId:string,apisecret:string,token: string) => {
	let error = null;

	const res = await fetch(`https://portal.huanghuaport.com.cn/unifyinterface/main/auth/getuserinfo`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
