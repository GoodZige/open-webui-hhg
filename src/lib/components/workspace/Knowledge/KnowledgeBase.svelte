<script lang="ts">
	...
	const toggleStyle=()=> {
    	let element = document.getElementById("toggle-Class");
    	element.classList.toggle("toggle-Class-zsk");
	}
				...
				<div class=" flex flex-col w-full space-x-2 rounded-lg h-full">
					<div class="w-full h-full flex flex-col">
						...
						>
							<path
								fill-rule="evenodd"
								d="M938.688 1024V0H1024v1024h-85.312zM0 768h853.312v256H0v-256z m85.312 85.312v85.376H768v-85.376H85.312zM0 0h853.312v256H0V0z m85.312 85.312v85.376H768V85.312H85.312zM170.688 384h682.624v256H170.688V384zM256 469.312v85.376h512V469.312H256z"
								clip-rule="evenodd"
							/>
						</svg>
							</button>
